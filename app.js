...
const app=express();
//ket noi csdl
mongoose.connect('mongodb+srv://manhtran:0399898172@cluster0.gmafrgs.mongodb.net/db2',{
...
const uploadsDir=path.join(__dirname,'anh');
app.use('/anh',express.static(uploadsDir));
//su dung ejs
